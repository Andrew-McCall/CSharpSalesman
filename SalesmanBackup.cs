...
namespace Salesman
{
    class SalesmanBackup
    {
        ...
        public static double DistanceBetweenSquared(DataPoint pointA, DataPoint pointB)
        {
            return Math.Pow(Math.Abs(pointA.X - pointB.X),2) + Math.Pow(Math.Abs(pointA.Y - pointB.Y), 2);
        }

        public static double DistanceBetween(DataPoint pointA, DataPoint pointB)
        {
